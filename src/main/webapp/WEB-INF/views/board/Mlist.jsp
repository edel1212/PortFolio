...
<body>
	...
	<%@ include file="../includes/sub-header.jsp" %>
        ...
        <div id="page-wrapper" style="min-height: 0px">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><a href="/board/Mlist">공지사항</a></h1>
                    <!-- 게시글 작성 btn -->
            ...
            <div class="row">
				...
				<div class="row" style="text-align: right">
					<div class="col-lg-12">
						<form id="serachForm" action="/board/Mlist" method="get">
							<select name="type">
	...
	$(document).ready(function(){
		...
		$('.move').on("click",function(e){
			...
			actionForm.attr("action", "/board/Mget");
			actionForm.submit();
		});//click
